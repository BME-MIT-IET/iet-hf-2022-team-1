...
import { combSort } from '../../src/comb_sort/comb_sort.js'
...
describe('comb sort algorithm', () => {
    ...
    it('should return a sorted array given an array of 3 numbers', () => {
        const array = [5, 1, -3];

        const sorted = combSort(array);

        expect(sorted).to.be.eql([-3, 1, 5]);
    });
});