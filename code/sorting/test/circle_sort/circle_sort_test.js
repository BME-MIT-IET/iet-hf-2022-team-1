...
import { circlesort } from '../../src/circle_sort/circle_sort.js'

describe('circle sort algorithm', () => {

    it('should return a sorted array given all elemenents are unique', () => {
        const array = [5, 8, 10, 2, 7, 1, 4, 3, 9, 6];

        while (circlesort(array, 0, array.length - 1, 0));
    ...
    it('should return a sorted array given an array with duplicate and negative elements', () => {
        ...
        expect(array).to.be.eql([-5, -4, -3, -3, -3, -3, -2, -2, -2, -2, -1, -1, 0, 1, 1, 1, 1, 2, 4, 4]);
    });
});